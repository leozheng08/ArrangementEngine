 ...
 */
@Service
public class ElfinBaseDataServiceImpl implements ElfinBaseDataService {
    private final static Logger logger = LoggerFactory.getLogger(ElfinBaseDataServiceImpl.class);
