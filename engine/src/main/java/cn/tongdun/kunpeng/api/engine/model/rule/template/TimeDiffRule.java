...
import cn.tongdun.kunpeng.api.engine.model.rule.function.location.GpsDistanceFunction;
...
public class TimeDiffRule extends AbstractRule {
    ...
    private TimeDiffFunction function;
    ...
    public void parse(RawRule rawRule) {
        ...
        function = (TimeDiffFunction) FunctionLoader.getFunction(rawRule.getFunctionDescList().get(0));
    }
}
