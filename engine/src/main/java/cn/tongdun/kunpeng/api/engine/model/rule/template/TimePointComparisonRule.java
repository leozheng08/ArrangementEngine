...
import cn.tongdun.kunpeng.api.engine.model.rule.function.time.TimeDiffFunction;
import cn.tongdun.kunpeng.api.engine.model.rule.function.time.TimePointComparisonFunction;

public class TimePointComparisonRule extends AbstractRule {

    private TimePointComparisonFunction function;
    ...
    public void parse(RawRule rawRule) {
        ...
        function = (TimePointComparisonFunction) FunctionLoader.getFunction(rawRule.getFunctionDescList().get(0));
    }
}
