...
public class LoadPolicyDefinitionByPartnerManager implements ILoadByPartner {

    private Logger logger = LoggerFactory.getLogger(LoadPolicyDefinitionByPartnerManager.class);
