...
public class ChassisPartnerClusterRepository implements IPartnerClusterRepository {
    ...
    private Logger logger = LoggerFactory.getLogger(ChassisPartnerClusterRepository.class);
    ...
    public Set<String> queryPartnerByCluster(String cluster) {
        ...
        logger.info(TraceUtils.getFormatTrace() + "ChassisPartnerClusterRepository success, cost:{}, size:{}", System.currentTimeMillis() - beginTime, partners.size());
        return partners;
    }
