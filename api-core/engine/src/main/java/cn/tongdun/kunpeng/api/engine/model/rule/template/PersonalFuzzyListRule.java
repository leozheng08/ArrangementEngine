 ...
 */
public class PersonalFuzzyListRule extends AbstractRule {

    private PersonalFuzzyListFunction personalFuzzyListFunction;

    @Override
    public EvalResult run(ExecuteContext executeContext) {
        return EvalResult.valueOf(personalFuzzyListFunction.eval(executeContext));
    }
    ...
    public void parse(RawRule rawRule) {
        ...
        personalFuzzyListFunction = (PersonalFuzzyListFunction) FunctionLoader.getFunction(rawRule.getFunctionDescList().get(0));
    }
}
