...
public class KeywordBatchRemoteCallDataBuilder implements BatchRemoteCallDataBuilder {
    ...
    public List<Object> build(RuleDTO dto){
        ...
        for(RuleConditionElementDTO elementDTO : elements){
            batchDataDTOS.add(this.createRemoteCallData(dto.getUuid(),elementDTO));
        }
     ...
     * @return
     */
    public KeywordBatchRemoteCallData createRemoteCallData(String ruleUuid,RuleConditionElementDTO elementDTO){
