...
public class GaeaPaasIndicatrixServiceConfiguration {
    ...
    public KpIndicatrixService gaeaPaasService(GaeaApi gaeaApi, PlatformIndexCache policyIndicatrixItemCache){
        GaeaPaasServiceImpl paasGaeaService = new GaeaPaasServiceImpl(gaeaApi, policyIndicatrixItemCache);
