package cn.tongdun.kunpeng.api.acl.impl.domain.event.notice.zk;
 ...
 */
@Repository
public class ZkDomainEventRepository implements IDomainEventRepository {

    private static Logger logger = LoggerFactory.getLogger(ZkDomainEventRepository.class);
    ...
    public List<String> pullLastEventMsgsFromRemoteCache(){
        ...
        try {
            for(int i=LAST_MINUTES-1;i>=0;i--){
                ...
                Set<IScoreValue> scoreValueSetTmp = new HashSet<>();//scoreKVRepository.zrangeByScoreWithScores(lastKey,0,Long.MAX_VALUE);
