 ...
 * <p/>
 * Use {@link RedisCacheManager} to create {@link TdRedisCache} instances.
 *
 ...
 * @since 2.0
 */
public class TdRedisCache extends AbstractValueAdaptingCache {
	...
	/**
	 * Create new {@link TdRedisCache}.
	 *
	 * @param name must not be {@literal null}.
	 * @param cacheWriter must not be {@literal null}.
	 * @param cacheConfig must not be {@literal null}.
	 */
	protected TdRedisCache(String name, RedisCacheWriter cacheWriter, RedisCacheConfiguration cacheConfig) {
